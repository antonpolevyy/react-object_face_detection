...
(function(){
    ...
    (function() {
    var p = "3960888", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3960888||'',
    GUID:window.ftGUID_3960888||'99999999999',
    confID:window.ftConfID_3960888||'0',
    ftReturn: window.ftReturn_3960888||'',
    keyword:window.ftKeyword_3960888||'',
    ftId:window.ftId_3960888||'',
    imp:window.ftImp3960888,
    ftImpId:window.ftImp3960888 && window.ftImp3960888.impID || '',
    campaignID:'104805',
    cID:'102331',
    pID:'3960888',
    creativeID:'2744687',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=104805&sid=240&plc=3960888&num=&adid=&advid=&adsrv=29&btreg=3960888&btadsrv=flashtalking&crt=2744687&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ["http://servedby.flashtalking.com/click/8/104805;3960888;2744687;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://acrobat.adobe.com/au/en/acrobat.html?sdid=7RZ367W3&mv=display"],
    placementDescription:'GoogleFY19AcrobatCTXCustomAffinityAUPAWB300x250',
    width:300,
    height:250,
    ...
    divID:'ftdiv3960888',
    phID:'ftpos3960888',
    frameID:'ftframe3960888',
    expID:'ftexpframe3960888',
    altImgID:'ftalt3960888',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/104805;3960888;2744687;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://acrobat.adobe.com/au/en/acrobat.html?sdid=7RZ367W3&mv=display',
    altImg:'http://servedby.flashtalking.com/imp/8/104805;3960888;204;gif;Google;GoogleFY19AcrobatCTXCustomAffinityAUPAWB300x250/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/104805;3960888;271;pixel;Google;GoogleFY19AcrobatCTXCustomAffinityAUPAWB300x250/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/396/3960888/2744687/js/j-3960888-2744687.js',
    file:'http://cdn.flashtalking.com/102331/2744687/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?145600671-3960888;2744687;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:false,
    segment:window.ftSegment_3960888||'',
    segmentList:window.ftSegmentList_3960888||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3960888 && window.ftImp3960888.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3960888')&&/^https:/.test(document.getElementById('ftscript_m3960888').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3960888'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3960888'],
        ['ftcfid', 'ftConfID_3960888'],
        ['fttime', 'ftTimestamp_3960888'],
        ['ftsection', 'ftSection_3960888'],
        ['ftcustom', 'ftCustom_3960888'],
        ['ft_id', 'ftId_3960888'],
        ['ftimpid','ftImp3960888', 'impID']
    ]
};
